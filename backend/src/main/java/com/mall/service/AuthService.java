...
public class AuthService {
    ...
    @Value("${mall.jwt.remember-expire}")
    ...
    public LoginResponse login(LoginRequest req) {
        ...
        long expireSeconds = Boolean.TRUE.equals(req.getRememberMe()) ? rememberExpire : expire;
        String token = jwtUtil.generateToken(user.getId(), user.getUsername(), user.getRole(), expireSeconds);
